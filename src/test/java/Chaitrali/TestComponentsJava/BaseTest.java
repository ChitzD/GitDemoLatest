package Chaitrali.TestComponentsJava;
...
public class BaseTest {
	...
	public WebDriver initializeDriver() throws IOException {
		...
		FileInputStream fis = new FileInputStream(System.getProperty("user.dir")
				+ "\\src\\main\\java\\Chaitrali\\imdbflow\\resources\\GlobalData.properties");
		prop.load(fis);
	...
	public videoPlayFlow launchApplication() throws IOException, InterruptedException {
		driver = initializeDriver();
		flow = new videoPlayFlow(driver);
		flow.goToSitePage();
		return flow;
	}
